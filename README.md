...
From source:
 ...
 clang 10 is able to apply some Auto-vectorization in AVX2 capable CPUs improving by ~25% the performance in Tanimoto searches. To get the boost set "FPSIM2_MARCH_NATIVE" to 1.
